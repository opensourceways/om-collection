...
from toolkit.introspect import find_signature_parameters
...
ARCHIVES_DEFAULT_PATH = '~/.collection/archives/'
...
def find_backends(top_package):
    ...
    Look for the Collection backends and commands under `top_package`
