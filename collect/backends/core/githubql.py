...
from collection.backends.core.github import (GitHub,
                                           GitHubClient,
                                           GitHubCommand,
                                           DEFAULT_SLEEP_TIME,
                                           MIN_RATE_LIMIT,
...
class GitHubQL(GitHub):
    """GitHubQL backend for Collection using the GitHub API v4.
    ...
    a GraphQL call. Each event is returned by Collection together
