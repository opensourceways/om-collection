...
from collection.backends.core.jenkins import (logger,
                                            Jenkins,
                                            JenkinsCommand,
                                            JenkinsClient,
                                            SLEEP_TIME, DETAIL_DEPTH)
from collection.errors import BackendError
...
class TestJenkinsBackend(unittest.TestCase):
    ...
    def test_initialization_error(self):
        ...
        with self.assertLogs(logger) as cm:
            ...
            self.assertEqual(cm.output[0], 'ERROR:collection.backends.core.jenkins:'
    ...
    def test_fetch_depth_1(self):
        ...
        with self.assertLogs(logger, level='WARNING') as cm:
            ...
            self.assertEqual(cm.output[0], 'WARNING:collection.backends.core.jenkins:500 Server Error: '
                                           'Internal Server Error for url: '
                                           'http://example.com/ci/job/500-error-job/api/json?depth=1')
            self.assertEqual(cm.output[1], 'WARNING:collection.backends.core.jenkins:Unable to fetch builds from job '
                                           'http://example.com/ci/job/500-error-job/; skipping')
            self.assertEqual(cm.output[2], 'WARNING:collection.backends.core.jenkins:Unable to parse builds from job '
    ...
    def test_fetch_no_job_builds(self):
        ...
        with self.assertLogs(logger, level='DEBUG') as cm:
            builds = [build for build in jenkins.fetch()]
            self.assertRegex(cm.output[1], 'DEBUG:collection.backends.core.jenkins:No builds for job.*')
            self.assertRegex(cm.output[2], 'DEBUG:collection.backends.core.jenkins:No builds for job.*')
    ...
    def test_fetch_depth_1_blacklist(self):
        ...
        with self.assertLogs(logger, level='WARNING') as cm:
            builds = [build for build in jenkins.fetch()]
            self.assertEqual(cm.output[0], 'WARNING:collection.backends.core.jenkins:Not getting blacklisted job: '
                                           'apex-build-brahmaputra')
            self.assertEqual(cm.output[1], 'WARNING:collection.backends.core.jenkins:500 Server Error: '
                                           'Internal Server Error for url: '
                                           'http://example.com/ci/job/500-error-job/api/json?depth=1')
            self.assertEqual(cm.output[2], 'WARNING:collection.backends.core.jenkins:Unable to fetch builds from job '
                                           'http://example.com/ci/job/500-error-job/; skipping')
            self.assertEqual(cm.output[3], 'WARNING:collection.backends.core.jenkins:Unable to parse builds from job '
                                           'http://example.com/ci/job/invalid-json-job/; skipping')
    ...
    def test_fetch_blacklist(self):
        ...
        with self.assertLogs(logger, level='WARNING') as cm:
            builds = [build for build in jenkins.fetch()]
            self.assertEqual(cm.output[0], 'WARNING:collection.backends.core.jenkins:'
...
class TestJenkinsBackendArchive(TestCaseBackendArchive):
    ...
    def test_fetch_from_archive(self):
        ...
        with self.assertLogs(logger, level='WARNING') as cm:
            ...
            self.assertEqual(cm.output[2], 'WARNING:collection.backends.core.jenkins:Unable to parse builds from job '
                                           'http://example.com/ci/job/invalid-json-job/; skipping')
            self.assertEqual(cm.output[3], 'WARNING:collection.backends.core.jenkins:500 Server Error: '
                                           'Internal Server Error for url: '
                                           'http://example.com/ci/job/500-error-job/api/json?depth=1')
            self.assertEqual(cm.output[4], 'WARNING:collection.backends.core.jenkins:Unable to fetch builds from job '
                                           'http://example.com/ci/job/500-error-job/; skipping')
            self.assertEqual(cm.output[5], 'WARNING:collection.backends.core.jenkins:Unable to parse builds from job '
                                           'http://example.com/ci/job/invalid-json-job/; skipping')
    ...
    def test_fetch_blacklist_from_archive(self):
        ...
        with self.assertLogs(logger, level='WARNING') as cm:
            ...
            self.assertEqual(cm.output[3], 'WARNING:collection.backends.core.jenkins:Unable to parse builds from job '
                                           'http://example.com/ci/job/invalid-json-job/; skipping')
            self.assertEqual(cm.output[4], 'WARNING:collection.backends.core.jenkins:'
                                           'Not getting blacklisted job: apex-build-brahmaputra')
            self.assertEqual(cm.output[5], 'WARNING:collection.backends.core.jenkins:500 Server Error: '
                                           'Internal Server Error for url: '
                                           'http://example.com/ci/job/500-error-job/api/json?depth=1')
            self.assertEqual(cm.output[6], 'WARNING:collection.backends.core.jenkins:Unable to fetch builds from job '
                                           'http://example.com/ci/job/500-error-job/; skipping')
            self.assertEqual(cm.output[7], 'WARNING:collection.backends.core.jenkins:Unable to parse builds from job '
                                           'http://example.com/ci/job/invalid-json-job/; skipping')
