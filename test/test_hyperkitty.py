...
from collection.backends.core.mbox import MailingList
from collection.backends.core.hyperkitty import (HyperKitty,
                                               HyperKittyCommand,
                                               HyperKittyList)
...
class TestHyperKittyList(unittest.TestCase):
    ...
    @httpretty.activate
    @unittest.mock.patch('collection.backends.core.hyperkitty.datetime_utcnow')
...
class TestHyperKittyCommand(unittest.TestCase):
    ...
    def test_mboxes_path_init(self, mock_expanduser):
        ...
        args = ['http://example.com/archives/list/test@example.com/',
                '--mboxes-path', '/tmp/collection/']

        cmd = HyperKittyCommand(*args)
        self.assertEqual(cmd.parsed_args.dirpath, '/tmp/collection/')
    ...
    def test_parsing_on_init(self):
        ...
        self.assertEqual(cmd.parsed_args.mboxes_path, '/tmp/collection/')
    ...
    def test_setup_cmd_parser(self):
        ...
        self.assertEqual(parsed_args.mboxes_path, '/tmp/collection/')
