...
from collection.client import RateLimitHandler
from collection.errors import RateLimitError
from collection.utils import (DEFAULT_DATETIME, DEFAULT_LAST_DATETIME)
from collection.backends.core.github import (logger, GitHub,
                                           GitHubCommand,
                                           GitHubClient,
                                           CATEGORY_ISSUE,
...
class TestGitHubBackend(unittest.TestCase):
    ...
    def test_fetch_pulls_ghost_reviewer(self):
        ...
        with self.assertLogs(logger, level='WARNING') as cm:
            ...
            self.assertEqual(cm.output[-1],
                             'WARNING:collection.backends.core.github:Impossible to identify '
    ...
    @httpretty.activate
    @unittest.mock.patch('collection.backends.core.github.datetime_utcnow')
    ...
    def test_fetch_more_pulls(self):
        ...
        with self.assertLogs(logger) as cm:
            ...
            self.assertEqual(cm.output[0],
                             'WARNING:collection.backends.core.github:'
    ...
    def test_fetch_more_pulls_no_user_data(self):
        ...
        with self.assertLogs(logger) as cm:
            ...
            self.assertEqual(cm.output[0],
                             "INFO:collection.backends.core.github:"
